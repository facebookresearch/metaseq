...
def generate(args):
    ...
    output_dir = "/data/home/aiema/gill/evals/gill_vist_outputs_test"
    ...
    for story_idx, (story_id, story_data) in tqdm(enumerate(islice(vist_data['annotations'].items(), 3500, 4000)), total=len(vist_data['annotations'])):
