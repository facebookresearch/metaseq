...
@register_model("base_transformer_lm", dataclass=TransformerLanguageModelConfig)
...
class ModelParallelTransformerLanguageModel(LanguageModel):
    @classmethod
    def build_model(cls, args, task):
        """Build a new model instance."""
...
@register_model_architecture("base_transformer_lm", "transformer_lm_gpt")
...
@register_model_architecture("base_transformer_lm", "transformer_lm_gpt2_tiny")
