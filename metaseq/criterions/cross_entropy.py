...
class CrossEntropyCriterion(BaseCriterion):
    ...
    def reduce_metrics(logging_outputs) -> None:
        ...
        target_tokens = sum(log.get("target_tokens", 0) for log in logging_outputs)
        ...
        if sample_size != target_tokens:
            metrics.log_scalar(
                "nll_loss", loss_sum / target_tokens / math.log(2), target_tokens, round=3
            )
            metrics.log_derived(
