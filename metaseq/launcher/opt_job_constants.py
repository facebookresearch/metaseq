...
MODEL_SIZES = {
    ...
    "760m": Size(24, 1536, 16, 96, int(0.5 * M), 2.5e-4, 1),  # large
    "1.3b": Size(24, 2048, 32, 64, int(1.0 * M), 2.0e-4, 1),  # xl
    "2.7b": Size(32, 2560, 32, 80, int(1.0 * M), 1.6e-4, 1),
    "6.7b": Size(32, 4096, 32, 128, int(2.0 * M), 1.2e-4, 1),
