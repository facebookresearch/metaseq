...
CHECKPOINT_FOLDER = "/fsx-mudslide/sviyer/models/instruct_models/aws.v7.prop10.0dr.redo.z7b.eps_4096.0edr.docsep_2.mu5000.wu60.bsz4.clip1.0.fp32adam.rs1234.lr5e-05.endlr5e-06.ngpu64"
...
MODEL_FILE = os.path.join(CHECKPOINT_FOLDER, "checkpoint_4400.pt")
