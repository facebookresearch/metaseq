...
@unittest.skipIf(DistributedTrainingConfig.distributed_world_size != 8, "test requires at least 8 GPU's") 
class TestTraining(unittest.TestCase):
    def test_training(self):
        ...
        r = subprocess.Popen("rm -r ./test-checkpoint".split(),stdout=subprocess.PIPE, stderr=subprocess.PIPE,universal_newlines=True)
        _,_ = r.communicate()
